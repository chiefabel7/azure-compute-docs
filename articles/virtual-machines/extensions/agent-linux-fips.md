...
|:----------|:---------------------------------------------------:|
| MICROSOFT.AKS.COMPUTE.AKS.LINUX.AKSNODE | Commercial |
| MICROSOFT.AKS.COMPUTE.AKS.LINUX.BILLING | Commercial |
...
| MICROSOFT.AZURE.NETWORKWATCHER.NETWORKWATCHERAGENTLINUX | Commercial |
...
| MICROSOFT.CPLAT.CORE.LINUXPATCHEXTENSION | Commercial |
...
| MICROSOFT.MANAGEDSERVICES.APPLICATIONHEALTHLINUX | Commercial |
