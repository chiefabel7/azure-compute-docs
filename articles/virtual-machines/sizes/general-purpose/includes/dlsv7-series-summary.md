...
---
Dlsv7-series virtual machines run on 6th Generation Intel@ Xeon® 6 processor (Granite Rapids) CPU processor reaching an all-core turbo clock speed of 4.2 GHz. This new processor 
...
These virtual machines offer up to 248 vCPU and 496 GiB of RAM. These virtual machine sizes can reduce cost when running non-memory intensive applications.
